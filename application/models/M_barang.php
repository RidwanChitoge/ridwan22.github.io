...
class M_barang extends CI_Model
{
    ...
    var $column_order    =  array(null, 'kode_barang', 'nama_barang', 'stok', null); //set column field database untuk datatable order
    var $column_search   =  array('kode_barang', 'nama_barang', 'stok'); //set column field database untuk datatable search
