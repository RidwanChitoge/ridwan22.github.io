...
class M_laporan extends CI_Model
{
    ...
    function getDataStokHarian($tanggal)
    {
        ...
        $select = 'kode_barang, nama_barang, stok, SUM(c.qty) AS qty_penjualan, SUM(d.qty) AS qty_pembelian, SUM(e.qty) AS qty_penjualan_new, SUM(f.qty) AS qty_pembelian_new';

        $group = ['kode_barang', 'nama_barang', 'stok'];
