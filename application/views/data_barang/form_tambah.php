...
<div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok" value="<?= set_value('stok'); ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <div class="col-sm-9 offset-md-3">
            <button type="submit" name="submit" value="submit" class="btn btn-primary btn-sm">Input Data</button>
